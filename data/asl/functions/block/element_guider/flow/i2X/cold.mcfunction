...
execute unless score @s asl_ir_i2 > @s el_vacancy_cold if score @s ele_cont_cold >= @s asl_ir_i2 run scoreboard players operation @s ele_cont_cold1 += @s asl_ir_i2
execute unless score @s asl_ir_i2 > @s el_vacancy_cold if score @s ele_cont_cold >= @s asl_ir_i2 run tag @s add ele_cold_changed
execute unless score @s asl_ir_i2 > @s el_vacancy_cold if score @s ele_cont_cold >= @s asl_ir_i2 run scoreboard players operation @s ele_cont_cold -= @s asl_ir_i2
