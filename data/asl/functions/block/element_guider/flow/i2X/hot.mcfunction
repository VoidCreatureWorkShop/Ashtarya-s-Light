...
execute unless score @s asl_ir_i2 > @s el_vacancy_hot if score @s ele_cont_hot >= @s asl_ir_i2 run scoreboard players operation @s ele_cont_hot1 += @s asl_ir_i2
execute unless score @s asl_ir_i2 > @s el_vacancy_hot if score @s ele_cont_hot >= @s asl_ir_i2 run tag @s add ele_hot_changed
execute unless score @s asl_ir_i2 > @s el_vacancy_hot if score @s ele_cont_hot >= @s asl_ir_i2 run scoreboard players operation @s ele_cont_hot -= @s asl_ir_i2
