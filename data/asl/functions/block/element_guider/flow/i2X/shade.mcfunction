...
execute unless score @s asl_ir_i2 > @s el_vacancy_shade if score @s ele_cont_shade >= @s asl_ir_i2 run scoreboard players operation @s ele_cont_shade1 += @s asl_ir_i2
execute unless score @s asl_ir_i2 > @s el_vacancy_shade if score @s ele_cont_shade >= @s asl_ir_i2 run tag @s add ele_shade_changed
execute unless score @s asl_ir_i2 > @s el_vacancy_shade if score @s ele_cont_shade >= @s asl_ir_i2 run scoreboard players operation @s ele_cont_shade -= @s asl_ir_i2
