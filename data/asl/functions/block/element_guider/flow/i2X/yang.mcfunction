...
execute unless score @s asl_ir_i2 > @s el_vacancy_yang if score @s ele_cont_yang >= @s asl_ir_i2 run scoreboard players operation @s ele_cont_yang1 += @s asl_ir_i2
execute unless score @s asl_ir_i2 > @s el_vacancy_yang if score @s ele_cont_yang >= @s asl_ir_i2 run tag @s add ele_yang_changed
execute unless score @s asl_ir_i2 > @s el_vacancy_yang if score @s ele_cont_yang >= @s asl_ir_i2 run scoreboard players operation @s ele_cont_yang -= @s asl_ir_i2
