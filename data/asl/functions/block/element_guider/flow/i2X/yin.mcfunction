...
execute unless score @s asl_ir_i2 > @s el_vacancy_yin if score @s ele_cont_yin >= @s asl_ir_i2 run scoreboard players operation @s ele_cont_yin1 += @s asl_ir_i2
execute unless score @s asl_ir_i2 > @s el_vacancy_yin if score @s ele_cont_yin >= @s asl_ir_i2 run tag @s add ele_yin_changed
execute unless score @s asl_ir_i2 > @s el_vacancy_yin if score @s ele_cont_yin >= @s asl_ir_i2 run scoreboard players operation @s ele_cont_yin -= @s asl_ir_i2
