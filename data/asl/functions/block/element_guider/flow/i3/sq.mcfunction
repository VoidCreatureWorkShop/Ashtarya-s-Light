...
execute unless score @s asl_ir_i3 > @s el_vacancy_sq if score @s ele_cont_sq >= @s asl_ir_i3 run data modify block ~ ~ ~ Items[{Slot:5b}].tag.CustomModelData set value 12010131
