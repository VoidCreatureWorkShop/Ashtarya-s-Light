...
#
execute unless score @s asl_ir_i3 > @s el_vacancy_yang if score @s ele_cont_yang >= @s asl_ir_i3 run data modify block ~ ~ ~ Items[{Slot:5b}].tag.CustomModelData set value 12010133
