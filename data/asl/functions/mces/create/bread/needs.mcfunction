#设置所需元素
scoreboard players set @s ele_need_yin 100
scoreboard players set @s ele_need_yang 20
scoreboard players set @s ele_need_hot 100
scoreboard players set @s ele_need_cold 50
