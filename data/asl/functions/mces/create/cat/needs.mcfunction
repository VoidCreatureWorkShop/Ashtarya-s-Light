#设置所需元素
scoreboard players set @s ele_need_yin 200
scoreboard players set @s ele_need_yang 200
scoreboard players set @s ele_need_hot 200
scoreboard players set @s ele_need_cold 200
scoreboard players set @s ele_need_light 200
scoreboard players set @s ele_need_shade 200
scoreboard players set @s ele_need_sq 200
#
