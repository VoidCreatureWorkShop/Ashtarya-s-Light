...
function vdc:module/mod_base/function/vec_toward
...
execute as @e[tag=asl_to] run function vdc:module/mod_base/function/vec_s_mot
...
execute as @e[tag=asl_to] run function vdc:module/mod_base/function/vec_s_drc
tag @e remove asl_to
